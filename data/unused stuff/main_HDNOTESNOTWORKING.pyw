...
def main_settings(): #bygpt
    ...
    if os.path.exists("data/settings.json"):
        with open("data/settings.json", "r") as jsonfile:
            ...
            for key in ["enable_particles", "debug", "low_quality", "downscroll", "hitsounds","hq_notesplashes","hitsounds_ignore_volume"]:
...
if low_quality:
    ...
    arrows_sizes = {
        'arrowLEFT0000': [488, 238, 155, 158],
        'arrowDOWN0000': [647, 238, 157, 155],
        'arrowRIGHT0000': [808, 238, 155, 157],
        'arrowUP0000': [323, 240, 157, 154],

        'blue0000': [0, 240, 158, 154],
        'down confirm0000': [0, 0, 240, 236],
        'down confirm0001': [244, 0, 240, 236],
        'down confirm0002': [1206, 235, 221, 218],
        'down confirm0003': [1206, 235, 221, 218],
        'down press0000': [805, 399, 143, 139],
        'down press0001': [805, 399, 143, 139],
        'down press0002': [1898, 0, 150, 146],
        'down press0003': [1898, 0, 150, 146],

        'green0000': [162, 240, 157, 154],
        'left confirm0000': [972, 0, 230, 232],
        'left confirm0001': [1438, 233, 220, 222],
        'left confirm0002': [1438, 0, 227, 229],
        'left confirm0003': [1438, 0, 227, 229],
        'left press0000': [1898, 449, 139, 142],
        'left press0001': [1898, 449, 139, 142],
        'left press0002': [1898, 150, 146, 149],
        'left press0003': [1898, 150, 146, 149],
        'left press0004': [1898, 150, 146, 149],
        'left press0005': [1898, 150, 146, 149],
        'left press0006': [1898, 150, 146, 149],
        'left press0007': [1898, 150, 146, 149],
        'left press0008': [1898, 150, 146, 149],
        'left press0009': [1898, 150, 146, 149],
        'left press0010': [1898, 150, 146, 149],
        'left press0011': [1898, 150, 146, 149],
        'left press0012': [1898, 150, 146, 149],
        'left press0013': [1898, 150, 146, 149],
        'left press0014': [1898, 150, 146, 149],
        'left press0015': [1898, 150, 146, 149],
        'left press0016': [1898, 150, 146, 149],
        'left press0017': [1898, 150, 146, 149],
        'left press0018': [1898, 150, 146, 149],
        'left press0019': [1898, 150, 146, 149],
        'purple0000': [0, 398, 154, 157],
        'red0000': [647, 397, 154, 157],
        'right confirm0000': [1669, 0, 225, 228],
        'right confirm0001': [1669, 232, 225, 228],
        'right confirm0002': [1206, 0, 228, 231],
        'right confirm0003': [1206, 0, 228, 231],
        'right press0000': [469, 400, 139, 142],
        'right press0001': [469, 400, 139, 142],
        'right press0002': [316, 398, 149, 152],
        'right press0003': [316, 398, 149, 152],
        'right press0004': [316, 398, 149, 152],
        'right press0005': [316, 398, 149, 152],
        'right press0006': [316, 398, 149, 152],
        'right press0007': [316, 398, 149, 152],
        'right press0008': [316, 398, 149, 152],
        'right press0009': [316, 398, 149, 152],
        'right press0010': [316, 398, 149, 152],
        'right press0011': [316, 398, 149, 152],
        'right press0012': [316, 398, 149, 152],
        'right press0013': [316, 398, 149, 152],
        'right press0014': [316, 398, 149, 152],
        'right press0015': [316, 398, 149, 152],
        'right press0016': [316, 398, 149, 152],
        'right press0017': [316, 398, 149, 152],
        'right press0018': [316, 398, 149, 152],
        'right press0019': [316, 398, 149, 152],
        'right press0020': [316, 398, 149, 152],
        'right press0021': [316, 398, 149, 152],
        'right press0022': [316, 398, 149, 152],
        'right press0023': [316, 398, 149, 152],
        'right press0024': [316, 398, 149, 152],
        'right press0025': [316, 398, 149, 152],
        'right press0026': [316, 398, 149, 152],
        'up confirm0000': [488, 0, 238, 234],
        'up confirm0001': [730, 0, 238, 234],
        'up confirm0002': [972, 236, 216, 212],
        'up confirm0003': [972, 236, 216, 212],
        'up press0000': [1898, 303, 144, 142],
        'up press0001': [1898, 303, 144, 142],
        'up press0002': [158, 398, 154, 151],
        'up press0003': [158, 398, 154, 151]
        }
    ...
    hd_notes_img = pg.image.load("images/NOTE_assets.png")

    x,y,width,height = arrows_sizes["purple0000"]
    cropped_segment = hd_notes_img.subsurface(pg.Rect(x, y, width, height))
    scaled_segment = pg.transform.scale(cropped_segment, (scale, scale))
    arrow_img["left_press"]=scaled_segment

    x,y,width,height = arrows_sizes["green0000"]
    cropped_segment = hd_notes_img.subsurface(pg.Rect(x, y, width, height))
    scaled_segment = pg.transform.scale(cropped_segment, (scale, scale))
    arrow_img["up_press"]=scaled_segment

    x,y,width,height = arrows_sizes["blue0000"]
    cropped_segment = hd_notes_img.subsurface(pg.Rect(x, y, width, height))
    scaled_segment = pg.transform.scale(cropped_segment, (scale, scale))
    arrow_img["down_press"]=scaled_segment

    x,y,width,height = arrows_sizes["red0000"]
    cropped_segment = hd_notes_img.subsurface(pg.Rect(x, y, width, height))
    scaled_segment = pg.transform.scale(cropped_segment, (scale, scale))
    arrow_img["right_press"]=scaled_segment




    x,y,width,height = arrows_sizes["arrowLEFT0000"]
    cropped_segment = hd_notes_img.subsurface(pg.Rect(x, y, width, height))
    scaled_segment = pg.transform.scale(cropped_segment, (scale, scale))
    arrow_img["left_base"]=scaled_segment

    x,y,width,height = arrows_sizes["arrowUP0000"]
    cropped_segment = hd_notes_img.subsurface(pg.Rect(x, y, width, height))
    scaled_segment = pg.transform.scale(cropped_segment, (scale, scale))
    arrow_img["up_base"]=scaled_segment

    x,y,width,height = arrows_sizes["arrowDOWN0000"]
    cropped_segment = hd_notes_img.subsurface(pg.Rect(x, y, width, height))
    scaled_segment = pg.transform.scale(cropped_segment, (scale, scale))
    arrow_img["down_base"]=scaled_segment

    x,y,width,height = arrows_sizes["arrowRIGHT0000"]
    cropped_segment = hd_notes_img.subsurface(pg.Rect(x, y, width, height))
    scaled_segment = pg.transform.scale(cropped_segment, (scale, scale))
    arrow_img["right_base"]=scaled_segment




    x,y,width,height = arrows_sizes["left press0000"]
    cropped_segment = hd_notes_img.subsurface(pg.Rect(x, y, width, height))
    scaled_segment = pg.transform.scale(cropped_segment, (scale, scale))
    arrow_img["left2_press"]=scaled_segment

    x,y,width,height = arrows_sizes["up press0000"]
    cropped_segment = hd_notes_img.subsurface(pg.Rect(x, y, width, height))
    scaled_segment = pg.transform.scale(cropped_segment, (scale, scale))
    arrow_img["up2_press"]=scaled_segment

    x,y,width,height = arrows_sizes["down press0000"]
    cropped_segment = hd_notes_img.subsurface(pg.Rect(x, y, width, height))
    scaled_segment = pg.transform.scale(cropped_segment, (scale, scale))
    arrow_img["down2_press"]=scaled_segment

    x,y,width,height = arrows_sizes["right press0000"]
    cropped_segment = hd_notes_img.subsurface(pg.Rect(x, y, width, height))
    scaled_segment = pg.transform.scale(cropped_segment, (scale, scale))
    arrow_img["right2_press"]=scaled_segment
...
def draw_overlay():
        ...
        if botplay and blatantbotplay:
            ...
            display.blit(botplay_text,(displaysize[0]-scale*0.1-botplay_text.get_rect().width,displaysize[1]-scale*1.2))  
...
def main():
    global started,dead,clock,gametime,chart,keystate,score,debug,particles,current_volume,misses,botplay,amogus,countdown_length,score_particles,last_score,hitsound_snd,enable_hitsounds,blatantbotplay
