...
class SettingsWindow: #bygpt
    def __init__(self, root, settings):
        ...
        self.column_max = round(len(settings_dict)/3)
...
def main():
    global started,dead,clock,gametime,chart,keystate,score,debug,particles,current_volume,misses,botplay,amogus,countdown_length,score_particles,last_score,hitsound_snd,enable_hitsounds
